...
int main() {
    ...
    int m1 = m.find("first")->second; // m에서 key값을 넣어 value를 얻어 채우세요
    int m2 = m.find("second")->second; // m에서 key값을 넣어 value를 얻어 채우세요
    int m3 = m.find("third")->second; // m에서 key값을 넣어 value를 얻어 채우세요
    int m4 = m.find("fourth")->second; // m에서 key값을 넣어 value를 얻어 채우세요
